	    ...
	    <div id="wrap">
	        ...
	        <div class="row">
	        	<div class="col-xs-6 col-sm-4 col-md-4 col-xs-offset-6 col-sm-offset-4 col-md-offset-4">
	        		<p class="text-center">Select person: </p>
	        		<input id="person_name" class="form-control txt-auto"/>
	        	</div>
	         ...
	         <div class="col-xs-12 col-sm-8 col-md-8 col-xs-offset-4 col-sm-offset-2 col-md-offset-2">
				...
				<table class="table table-bordered">
				  ...
				  <tr>
				    ...
				    <td><input type='text' id='surname_1' name='surname[]'/></td>
				    <td><input type='text' id='forename_1' name='forename[]'/></td>
