<html>
   ...
   <!-- autocomplete code start-->
        ...
        <!-- code activity type drop down menu -->
...
<p>Alternate name <input type="text" name="alt_name" /></p>
...
<p>or <button type="button" class="newPerson" onclick="newPerson()">
...
<p>or <button type="button" class='newSource' onclick="newSource()">
...
<p>or <button type="button" class="newPerson2" onclick="newPerson2()">
Create New Person</button></p>
</div>
